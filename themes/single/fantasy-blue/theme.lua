...
theme.bg_minimize   = "#99EEFF66"
theme.bg_urgent     = "#FF0000FF"

theme.fg_focus      = "#FFFFFFFF"
theme.fg_normal     = "#000000FF"
theme.fg_minimize   = "#00000033"
...
theme.wallpaper_cmd = { "awsetbg -a -r " .. os.getenv("HOME") .. "/.config/awesome/themes/single/fantasy-blue/wallpapers/" }
